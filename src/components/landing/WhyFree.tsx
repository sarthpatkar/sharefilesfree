  ...
  return (
    <section id="why" className="scroll-mt-20 border-b border-rule">
      <div className="mx-auto w-full max-w-[1400px] px-5 py-20 sm:px-8 sm:py-28">
        ...
        <Reveal delay={90}>
          <h2 className="mt-10 max-w-3xl font-display text-[clamp(2rem,5vw,3.75rem)] font-medium leading-[1.02] tracking-[-0.03em] text-ink">
          ...
          {PILLARS.map((pillar, i) => (
            ...
            >
              <div className="sff-cell group h-full px-0 py-9 hover:bg-ink sm:px-8 sm:[&]:first:pl-0">
                ...
                <h3 className="mt-4 font-display text-2xl font-medium tracking-[-0.02em] text-ink transition-colors group-hover:text-paper">
                  {pillar.title}
                </h3>

...
function AppJsonLd() {
  const json = {
    ...
    description:
      "Send a file of any size to any device with a short code. No account, no app, and no size limit at all — files pass directly between browsers and are never stored. Plus 24 free tools that run on your own device.",
